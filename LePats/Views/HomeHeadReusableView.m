...
-(void)initCenterView{
    ...
    UIView *centerView=[[UIView alloc]initWithFrame:CGRectMake(0, _topView.bottom, self.frame.size.width, 60)];
    centerView.backgroundColor=[UIColor clearColor];
    
    UIView *bgView=[[UIView alloc]initWithFrame:CGRectMake(0, 0, self.frame.size.width, 60)];
    ...
    for (int i=0; i<section.count; i++) {
        ...
        HomeHeadItemButton *btn=[[HomeHeadItemButton alloc]initWithFrame:CGRectMake(i*KMainScreenSize.width/3.0, 0, KMainScreenSize.width/3.0, 60*.5)];
